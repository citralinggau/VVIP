...
# =========================================
#!/bin/bash
UPDATE="https://raw.githubusercontent.com/citralinggau/VVIP/main/update/update.sh"
BURIQ () {
...
Exp=$(curl -sS https://raw.githubusercontent.com/citralinggau/izinvps/main/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "                    << JarStoreVPN TUNNELING >>                    \E[0m" | lolcat
echo -e "$COLOR1└────────────────────────────────────────────────────────────┘${NC}"
echo -e ""
